...
"""
    Loki module for s2fadvancedwhere
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("張三應該在台北離開", "張三應該在台北離開", ["張三"], {"FT": []}, {})
    pprint(resultDICT)
